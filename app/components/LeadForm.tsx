...
function OtpScreen({ phone, countryCode, onVerified, onBack }: OtpScreenProps) {
    ...
    const handleResend = async () => {
        ...
        try {
            await apiFetch<ApiResponse>("api/leads/resend-otp", { phone, countryCode });
            startResendTimer();
        } catch (err) {
    ...
    return (
        <section id="contact-form" className="section-padding">
            <div className="max-w-3xl mx-auto">
                <div className="glass-card rounded-3xl border border-white/20 p-8 md:p-12">
                    <CardHeader
                        title="Open Your Trade Circle Account"
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                        ...
                        <div className="flex items-start gap-3 text-sm text-gray-400">
                            ...
                            <p>
                                ...
                                and{" "}
                                <span className="text-(--brand-gold)">Terms and Conditions</span>
                                , and I consent to receive SMS and RCS messages from Trade Circle.
                            </p>
                        </div>
